...
import { BarChart3, ClipboardList, LogOut, Package, ShieldCheck } from "lucide-react";
  ...
  return (
    <main className="min-h-screen bg-[#09090b] text-white">
      <div className="pointer-events-none fixed inset-0 opacity-70">
        <div className="absolute left-[-12rem] top-[-10rem] h-96 w-96 rounded-full bg-amber-500/10 blur-3xl" />
      ...
      <div className="relative z-10 flex min-h-screen">
        ...
        <section className="flex min-w-0 flex-1 flex-col">
          <header className="sticky top-0 z-20 border-b border-white/10 bg-[#09090b]/85 px-5 py-4 backdrop-blur-xl lg:hidden">
