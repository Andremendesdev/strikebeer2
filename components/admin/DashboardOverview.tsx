...
const statusStyles: Record<OrderStatus, { badge: string; dot: string }> = {
  pending: { badge: "border-amber-400/30 bg-amber-500/10 text-amber-300", dot: "bg-amber-400" },
  ...
  return (
    <div className="space-y-8">
      ...
      <section className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-white/[0.035] p-6 md:p-8">
        <div className="pointer-events-none absolute right-0 top-0 h-64 w-64 translate-x-1/3 -translate-y-1/3 rounded-full bg-[var(--neon)] opacity-5 blur-3xl" />
        <div className="relative flex flex-col justify-between gap-4 md:flex-row md:items-end">
          <div>
            ...
            <h1
              className="mt-2 text-5xl uppercase leading-none text-white md:text-7xl"
          ...
          <span className="w-fit rounded-full border border-emerald-400/20 bg-emerald-500/10 px-4 py-2 text-xs font-bold uppercase tracking-[0.16em] text-emerald-300">
            ● Sistema online
          </span>
        </div>
      </section>
