...
const ADMIN_EMAIL = "admin@strikebeer.com";
const ADMIN_PASSWORD = "strikebeer123";
  ...
  return (
    <main className="grid min-h-screen place-items-center bg-[#09090b] px-6 text-white">
      <div className="pointer-events-none fixed inset-0">
        <div className="absolute left-1/2 top-[-12rem] h-[28rem] w-[28rem] -translate-x-1/2 rounded-full bg-amber-500/10 blur-3xl" />
      </div>
