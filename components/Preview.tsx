...
const reviews = [
  {
    ...
    date: "há 1 semana",
    rating: 5,
    text: "Melhor burger da cidade, sem discussão. O Strike Smash é absurdo e a cerveja gelada chega na temperatura perfeita. Ambiente rock de verdade.",
  },
  {
    id: 2,
    name: "Camila S.",
    date: "há 2 semanas",
    rating: 5,
    text: "Fomos no show ao vivo no sábado e ficamos impressionados. Atendimento rápido, cardápio premium e aquele clima de pub underground que a gente adora.",
  },
  {
    id: 3,
    name: "Bruno T.",
    date: "há 3 semanas",
    rating: 5,
    text: "Rock'n Bacon é uma obra de arte. Cervejas artesanais com rótulos que você não acha em qualquer lugar. Voltarei toda semana.",
  },
  {
    id: 4,
    name: "Juliana P.",
    date: "há 1 mês",
    rating: 4,
    text: "Experiência incrível do início ao fim. Só achei que no pico do fim de semana demora um pouco mais, mas vale cada minuto de espera.",
  },
  {
    id: 5,
    name: "Marcos A.",
    date: "há 1 mês",
    rating: 5,
    text: "Strike Beer virou nosso point fixo. Qualidade de restaurante gourmet com alma de rock bar. Recomendo o Thunder Beast pra quem quer algo especial.",
  },
  {
    id: 6,
    name: "Fernanda L.",
    date: "há 2 meses",
    rating: 5,
    text: "Decoração impecável, som ambiente na medida e equipe super atenciosa. O pedido pelo app chegou certinho e quentinho. Nota 10 no Google!",
  },
];
...
function ReviewCard({
  ...
  return (
    <motion.article
      ...
      className="flex flex-col gap-3 p-5 rounded-2xl h-full"
      style={{
        background: "#111113",
    ...
    >
      ...
      <p className="text-sm text-zinc-400 leading-relaxed flex-1">{review.text}</p>
    </motion.article>
  );
}
